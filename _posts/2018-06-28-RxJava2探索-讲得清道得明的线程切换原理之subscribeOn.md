...
如果你清楚了这里要表示的这个原理，你可能就已经猜到为什么subscribeOn方法只有第一次指定线程的地方是有效的，我就不用费口舌了，文章到此结束。。。那是不可能的，说好了要再装几分钟的x，怎么可能这么快。产品经理快扶我一把，虽然手断了，但我还要撸代码。
...
#### 3.4.2 Observable多次subscribeOn的流程
